...
//		StartsWith str2= new StartsWith("b");
//		And<String> and = new And(str,str2);
//		System.out.println(and.accepts("bat"));
...
//		AcceptsAny<String> any = new AcceptsAny<String>(listy);
//		System.out.println(all.accepts(str));
//		System.out.println(any.accepts(str));
//		PredicateUtilities<String> filterer = new PredicateUtilities();
//		List<String> smaller = filterer.listFilter(str, listy);
